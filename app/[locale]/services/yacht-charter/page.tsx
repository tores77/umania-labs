...
import ServiceHeroYacht from "@/components/services/ServiceHeroYacht";
...
import { whatsappYachtLink, SITE_URL } from "@/lib/constants";
import { routing, type Locale } from "@/i18n/routing";

export const revalidate = 60;

const SERVICE_PATHNAME = "/services/yacht-charter" as const;
...
export default async function YachtCharterServicePage({ params }: Props) {
  const { locale } = await params;
  ...
  const whatsappHref = whatsappYachtLink(locale as "es" | "en");
  ...
  return (
    <>
      ...
      <main id="main-content" style={{ background: "var(--bg)" }}>
        ...
        <ServiceHeroYacht service={SERVICE} whatsappHref={whatsappHref} />
