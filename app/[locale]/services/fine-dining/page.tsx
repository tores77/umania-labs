...
import ServiceHeroFineDining from "@/components/services/ServiceHeroFineDining";
...
import { whatsappFineDiningLink, SITE_URL } from "@/lib/constants";
import { routing, type Locale } from "@/i18n/routing";

export const revalidate = 60;

const SERVICE_PATHNAME = "/services/fine-dining" as const;
...
export default async function FineDiningServicePage({ params }: Props) {
  const { locale } = await params;
  ...
  const whatsappHref = whatsappFineDiningLink(locale as "es" | "en");
  ...
  return (
    <>
      ...
      <main id="main-content" style={{ background: "var(--bg)" }}>
        ...
        <ServiceHeroFineDining service={SERVICE} whatsappHref={whatsappHref} />
